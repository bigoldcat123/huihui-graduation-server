...
use huihui_server::{handlers::{auth_handlers, food_handlers, restaurant_handlers, static_handlers, suggestion_handlers, tag_handlers, topic_handlers, upload_handlers}, init_db};
